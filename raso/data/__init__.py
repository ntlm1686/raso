...
from .dataset import pretrain_dataset, finetune_dataset, finetune_video_dataset
...
def create_dataset(dataset, config, min_scale=0.5):
    ...
    elif dataset=='finetune_video':   
        dataset = finetune_video_dataset(config['train_file'], transform_train, transform_inputsize_224, class_num=config['class_num'], root=config['image_path_root'])              
        return dataset  
